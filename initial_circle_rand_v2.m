function [rbead, rmyo, ipt, ifor, bancf, bancm, xmat, fmmat] = initial_circle_rand (rhom, rhof, rhoain, r, la, wr, d_for, d_myo, dbead, rexc, rxbind)
...
%         rmyo(1:2,:) = rmyo(1:2,:) * (1 - d_myo /r); 
    ...
    if nf > nm * 4
        error('not enough myosins to fit formin')
    end
