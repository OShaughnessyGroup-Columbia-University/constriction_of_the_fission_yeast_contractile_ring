...
%% 2d scan
x1 = linspace(0.4,1.8,8)*0.2857;
x2 = linspace(0.015,0.0255,8);
[X1,X2] = meshgrid(x1,x2);
myp2_binding_energy = X1(itask);
rex_act = X2(itask);
%% Constants
% Misc.
...
% Forces
    ...
    myo2_binding_energy = 0.2145;
    kcap = myo2_binding_energy * 2 / (rcapmyo_short-r_flat_myo)^2;
    kcap_p = 2 * myp2_binding_energy / (rcapmyp-r_flat_myp)^2;
