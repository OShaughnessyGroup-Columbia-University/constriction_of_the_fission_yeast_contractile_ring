...
% change from v44: use update_v23
% change from v46: use get_force_v14
% change from v47: use get_force_v15
% change from v48: use update_v24 (nucleate along ring)
...
% %             poly_time = false;
% %         end
        [rbead, rmyo, rmyp, xmat, fmmat, ipt, ifor, bancf, bancm, dbead_first, bpmat_trial, t_rbead, t_rmyo, t_rmyp] = update_v24(rbead, rmyo, rmyp, bpmat, xmat, rhoain, rxbind, rex_act, rexc_n, fmmat, bancf, bancm, ifor, ipt, kofffor, ...
