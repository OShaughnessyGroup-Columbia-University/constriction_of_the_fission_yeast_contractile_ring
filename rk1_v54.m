% SAME AS RK1_V48GAUSS, BUT SELECTS FILAMENTS FROM X SECTION RANDOMLY TO INTERACT 
% WITH NODES AND MYP2 CLUSTERS, AND ALLOWS VARIABLE NUMBER OF HEADS PER MYP2 CLUSTER
