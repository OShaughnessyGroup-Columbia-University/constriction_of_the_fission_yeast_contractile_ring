...
% change from v1: scan initial r according to itask, then change r back to
% 1.85
% v2 skipped
...
% Geometry
    % radius of the intact cell (3.7 ?m diameter in Pelham Chang Fig. 4)
    r = 3.7/2 - itask*0.07;    
...
%         lr = new_r * 2 * pi; % length of the ring
    lr = r * 2 * pi;    
    lf = 1.3; % initial mean length of actin filament in the ring
