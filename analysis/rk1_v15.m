...
% change from v13: use get_pcpq_xy_v1. Do not compute anc_flag outside
% get_pcpq_xy_v1.
% v14 skipped
...
% % %         end
        if mod(itimes,(0.2/dt))==1
            [rbead,rmyo,rmyp,xmat,fmmat,ipt,ifor,bancf,bancm,dbead_first,bpmat_trial] = update_v7(rbead,rmyo,rmyp,bpmat,xmat,rhoain,rxbind,fmmat,bancf,bancm,ifor,ipt,kofffor,...
        ...
        if geometry == 'cyl'
            ...
            [pcpq, cvec, cdot, anc_flag] = get_pcpq_xy_v1(rbead,rmyo,rmyp,ifor,fmmat,bancf,bancm,r_ring,dbead_sq,vs_abs,dbead_first,vpol,d_for,d_myo);
        elseif geometry == 'sph'
            zbm = mean(rbead(3,:));
            r_ring = sqrt(r*r - zbm*zbm);
            [pcpq, cvec, cdot, anc_flag] = get_pcpq_xy_v1(rbead,rmyo,rmyp,ifor,fmmat,bancf,bancm,r_ring,dbead_sq,vs_abs,dbead_first,vpol,d_for,d_myo,d_stem);
        end        
