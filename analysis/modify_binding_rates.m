...
%     end
    ...
    binding_rate_myo2 = spline(time_wu, rho_myo2_exp, real_t_min)/18 * binding_rate_myo2_init;
    binding_rate_myp2 = spline(time_wu, rho_myp2_exp, real_t_min)/9 * binding_rate_myp2_init;
    ...
    n_cdc12 = spline(time_chen, n_cdc12_exp, real_t_min);
