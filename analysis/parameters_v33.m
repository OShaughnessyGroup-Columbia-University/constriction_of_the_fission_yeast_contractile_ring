...
% change from v18: Myp2p binding rate set to zero (del myp2)
% change from v19: scan amplication factor for fhead, fone, unbinding
% forces and repulsive force
% v20 to v26 skipped
% change from v27: formin anchor drag set to zero
% v28 to v31 skipped
% change fron v32: WT (myp2 binding rate set to normal). No scanning. also
% amplify kexc and kex_act
...
% Forces
    ...
    myo2p_unbinding_force = 16.8*amp;
    kcap = myo2p_unbinding_force / (rcapmyo_short-r_flat_myo);
    myp2p_unbinding_force = 16.9*amp;
