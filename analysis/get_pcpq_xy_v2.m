% change from original: formins are independently anchored
% v1 skipped
function [pcpq, cvec, cdot] = get_pcpq_xy_v2(rbead,rmyo,rmyp,ifor,fmmat,bancf,bancm,r_ring,dbead_sq,vs_abs,dbead_first,vpol,d_for,d_myo)
