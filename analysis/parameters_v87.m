...
% change from v58: add rexc_po, kexc_po temporarily set to zero
% change from v59: kexc_po set to kexc trying to reproduce obind2
% v60 skipped
% change from v61: use myo2p_unbinding_force = 8, scan kexc_po
% change from v62: 2d scan of myo2p_unbinding_force and kexc_po
% change from v63: use best values of myo2p_unbinding_force and kexc_po
% (#38), scan fhead and fheadmyp
% change from v64: range of fhead and fheadmyp changed
% change from v65: no scan, use fhead = fheadmyp = 2 pN
% v66 skipped
% change from v67: use corrected best values of myo2p_unbinding_force and kexc_po
% (#21)
% change from v68: 2d scan fhead and fheadmyp
% change from v69: range of fhead and fheadmyp changed
% change from v70: use best values of fhead and fheadmyp (#38)
% change from v71: scan number of Myp2 per cluster
% v72 to 76 skipped
% change from v77: gmsol reduced to 8 (might need to further reduce), use
% best-fit parameters of fhead and fheadmyp
% v78 to 81 skipped
% change from v82: increase unbinding thresholds by 3 fold
% v83 and 84 skipped
%% scan myo2p_unbinding_force
x1 = [4,8,16,24,32,42,52,64]; 
x2 = 1:8;
...
x1 = linspace(0,10,9); 
x1(1) = [];
x2 = linspace(0,1.57,9);
x2(1) = [];

[X1,X2] = meshgrid(x1,x2);
myo2p_unbinding_force = X1(34);
fhead_fv = X2(34);
%% Constants
% Misc.
...
% Forces
    ...
    %myo2p_unbinding_force = 30;
    myp2p_unbinding_force = 30 * nheadmyp/16;
...
% turnover
    ...
    temp = 2000/nheadmyp/10;
    binding_rate_myp2 = koffmyp * temp;
