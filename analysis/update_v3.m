% change from v2: number of on/off components are set according to how
% often update_v3 is run
% remaining issues: xlinker number decreases in time.

function [rbead,rmyo,rmyp,xmat,fmmat,ipt,ifor,bancf,bancm,dbead_first,bpmat_trial] = update_v3(rbead,rmyo,rmyp,bpmat,xmat,rhoain,rxbind,fmmat,bancf,bancm,ifor,ipt,kofffor,...
...
% % %     nbefore = sum(xmat(:)) * .5;
    ...
    bpmat_trial = bpmat;
        ...
        nmypturn = koffmyp * size(rmyp,2)/2 * atp_cycle;
        % make it an integer
