...
%% 2d scan
x1 = linspace(0.1,0.05,8);
x2 = linspace(0.1,0.5,8);
x3 = linspace(1,0.1,8);
[X1,X2,X3] = meshgrid(x1,x2,x3);
rcapmyp = X1(itask);
repulsion_energy = X2(itask);
drag_prefactor = X3(itask);
...
% Forces
    ...
    myo2_binding_energy = .5 * 500 * rcapmyo_short^2;
    kcap = myo2_binding_energy * 2 / rcapmyo_short^2;
    myp2_binding_energy = 0.855; % 0.855 in the good batch
    kcap_p = 2 * myp2_binding_energy / rcapmyp^2;
    ...
    rexc_n = rexc;   
    kexc = 40;
    kexc_po = repulsion_energy * 2 / rexc^2;
