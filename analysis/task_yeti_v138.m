...
% change from v111: use parameters_v77 and rk1_v36, name sizep
% v112 to 118 skipped
% change from v119: use rk1_v38, name sizep2
% change from v125: use parameters_v82, name sizep3
% v126 to 131 skipped
% change from v132: use rk1_v39, name sizep4
% v133 skipped
% change from v134: use parameters_v85, name sizep5
% v135 and 136 skipped
% 138 prints frequently to see transient during ring assembly
...
%% run simulation
totaltime = 5*60; % just running to see initial state transient
