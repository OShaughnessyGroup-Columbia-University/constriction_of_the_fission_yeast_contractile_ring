...
% change from v56: parameters_v43, time step = 2/11, full constriction, name wtfc
% v57 to 59 skipped
% change from v60: parameters_v44, no constriction, use run_pos_z_cyl_v5, rk1_v14, name e12d
% change from v61: parameters_v49, time step = .02, name e12d2
% v62 to 66 skipped
...
geometry = 'cyl'
full_constriction = false;
if geometry == 'cyl'
    if full_constriction
        run_pos_z_cyl_v5
    else
        run_pos_z_cyl_v4
    end
...
for t = loadj:loadj + totaltime-1
    ...
    dt = 0.02;
    nstep = 60/dt;      % one save per minute
    equil_time_min = 10;
