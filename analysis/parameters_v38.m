...
% change from v36: use 16.9*2 for both myo2p_unbinding_force and
% myp2p_unbinding_force. 2d scan of Myo2p and Myp2p head force.
% change from v37: "3d" scan, actually a 2d scan where each is repeated 8
% times
%% 2d scan of myo2p_unbinding_force and myp2p_unbinding_force
x1 = linspace(1,3,8); 
x2 = linspace(1,3,8);
x3 = linspace(1,3,8);
...
%     fheadmyp = 1*2;
    ...
    myo2p_unbinding_force = 16.9*2;
    myp2p_unbinding_force = 16.9*2;
