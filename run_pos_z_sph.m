...
% Geometry
    % radius of the protoplast (3.7 / 2 in septation paper)
    r = 3.7/2;      
...
for itrial = 1:1e5
    ...
    [rmyo, bancm, ipt, ifor, rbead, bancf, xmat] = initial_iso_sph (z_up, rhom, rhof, rhoain, r, lr, wr, d_for, d_myo, dbead, rxbind);
        fil_tag = 1:numel(ipt);
        r_ring = r;
...
bancm(randperm(nm,round(nm*8/11))) = false;      % myp2 are unanchored