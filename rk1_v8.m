...
% % %         end
        if mod(itimes,(0.2/dt))==1
            [rbead,rmyo,rmyp,xmat,fmmat,ipt,ifor,bancf,bancm,dbead_first,bpmat_trial] = update_v6(rbead,rmyo,rmyp,bpmat,xmat,rhoain,rxbind,fmmat,bancf,bancm,ifor,ipt,kofffor,...
        ...
        nsat_p = nsat;
        [force, gbeadfv, gppf, bmmatpt, bpmatpt] = get_force_v1(rbead,rmyo,rmyp,rdiff,ifor,ipt,bancm,bmmat,bpmat,nhead,fhead,fheadmyp,fone,nsat,rcapmyo_u, rcapmyo_long, rcapmyo_short,rcapmyp,kcap,kcap_p,dbead,vmyo0,kod2,r_ring,kwall,kexc,rexc,rexc_n,kex_act,rex_act,xmat,rx0,kx,d_cdc15,d_myo,geometry);
