...
% change from v2: output l_mean_goal
function [binding_rate_myo2, binding_rate_myp2, binding_rate_cdc12, vpol, rsev, l_mean_goal] = modify_binding_rates_v3(real_t_min, binding_rate_myo2_init, binding_rate_myp2_init, binding_rate_for_init, kofffor, r, r_ring, rhof, koffmyo)
%     if real_t_min < 5
