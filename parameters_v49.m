...
% 40 pN max
% v37 and v38 skipped 
% change from v39: use 28.57 pN and 11.43 pN for Myo2 and Myp2 unbinding
% forces, respectively; use 3.1 and 78 for actin and myosin drags,
% respectively.
% v40 to v42 skipped
% change from v33:  Myo2-E1, fhead = 0; 2d scan of Myo2p unbinding force and
% Myo2p effective gamma; nsat = 0
% change from v44: use original actin and myosin drags
% v45 to 48 skipped
%% 2d scan
x1 = linspace(0,40,8); % previous best value 16.8 = x1(5)
x2 = 0:7;
...
% Forces
    ...
    gm =777; % best value 777 under amplification factor 2
