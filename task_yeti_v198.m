...
x1 = [0.2, 0.4, 0.8, 1.2, 1.6];
x2 = [0.001, 0.002, 0.003, 0.004, 0.005];
x3 = 1:20;
...
%    dt = .05;
    ...
    save(strcat(prefix,num2str(itask),'_0',suffix), 'real_t_min','rbead','rmyo',...
        ...
        'vpol','rsev','vbead','vmyo','vmyp','t_rbead','t_rmyo','t_rmyp','gb','gm');
end
...
for t = loadj:tprint:loadj + totaltime-1
    ...
    save(strcat(prefix,num2str(itask),'_',num2str(tsave),suffix), 'real_t_min','rbead',...
        ...
        'binding_rate_for','vpol','rsev','vbead','vmyo','vmyp','t_rbead','t_rmyo','t_rmyp','gm','gb','rex_act');
    if r_ring < 0
        break
    end
end
