...
tass1 = 5*60; % in seconds
tprint = 10; % seconds
for t = loadj:tprint:loadj + tass1 - tprint
...
tass2 = 5*60;
for t = loadj + tass1:tprint:loadj + tass1 + tass2 - tprint
    load(strcat(prefix,num2str(itask),'_',num2str(t),suffix))
    dt = .2;
    nstep = tprint/dt;
    real_t_min = 0;
...
for t = loadj + tass1 + tass2:tprint:loadj + tass1 + tass2 + totaltime - tprint
    load(strcat(prefix,num2str(itask),'_',num2str(t),suffix))
    dt = .2;
    nstep = tprint/dt;
    equil_time_min = 0;
    real_t_min = (t - tass1 - tass2)/60; % real time, in minutes
