...
% change from v17: Myo2-E1, fhead = 0; 2d scan of Myo2p unbinding force and
% Myo2p effective gamma; Myp2p unbinding force 16.0
% v18 to v24 skipped
% change from v25: 2d scan of Myo2p unbinding force (smaller range), Myo2p effective gamma set to 2
% scan Myp2p unbinding force 16.0 

%% 2d scan
x1 = linspace(0,4.8,8); 
x2 = linspace(6,25,8); % previous best value 16.9 = x2(5)
...
%     myo2p_unbinding_force = 16.8;
    kcap = myo2p_unbinding_force / (rcapmyo_short-r_flat_myo);
%     myp2p_unbinding_force = 16.9;
