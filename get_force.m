function [force, gbeadfv, gppf, bmmatpt, bpmatpt] = get_force(rbead,rmyo,rmyp,rdiff,ifor,ipt,bancm,bmmat,bpmat,nhead,fhead,fheadmyp,fone,nsat,rcapmyo_u, rcapmyo_long, rcapmyo_short,rcapmyp,kcap,kcap_p,dbead,vmyo0,kod2,r_ring,kwall,kexc,rexc,kex_act,rex_act,xmat,rx0,kx,d_cdc15,d_myo,geometry)
