...
% change from v111: use run_pos_z_cyl_v9, parameters_v72, name delmyp4
% change from v112: use old dt = 0.02 s, name delmyp5
% v113 to 115 skipped
% change from v116: use dt = 0.1 s, name delmyp6
% change from v117: use parameters_v79, name delmyp7
% v118 to 128 skipped
% change from v129: save every second, name delmyp8
% v130 to 132 skipped
...
%% run simulation
totaltime = 600; % ring radius divided by septation rate is 26 minutes  
warmuptime = .5;
