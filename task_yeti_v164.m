...
gm = 2e3*gmlist(xtask + nval*(xtask==0));
...
if loadj==0
    ...
    rk1_v42
    save(strcat(prefix,num2str(itask),'_0',suffix), 'real_t_min','rbead','rmyo','rmyp','ifor','ipt','bancf','bancm','xmat','fmmat','dbead_first','r','r_ring','fc','fanc','binding_rate_myo2','binding_rate_myp2','binding_rate_for','vpol','rsev','vbead','vmyo','vmyp','gm')
end
tprint = 30;
...
for t = 0:tprint:totaltime-1
    ...
    tsave = t+tprint;
    clear t
    save(strcat(prefix,num2str(itask),'_',num2str(tsave),suffix), 'real_t_min','rbead','rmyo','rmyp','ifor','ipt','bancf','bancm','xmat','fmmat','dbead_first','r','r_ring','fc','fanc','binding_rate_myo2','binding_rate_myp2','binding_rate_for','vpol','rsev','vbead','vmyo','vmyp','force_vec','gm')
    if r_ring < 0
        break
    end
end
