...
ipar2 =1;    
    ...
    imyp = 1:size(rmyp,2);
    % plot unanchored    
    circles(rmyp(1,:),rmyp(2,:),.07,'facecolor',[0,255,255]/255,'edgecolor','none')
...
%         iunanc(iunanc == ipar - size(rbead,2)) = [];
    ...
    circles(rmyo(1,ianc),rmyo(2,ianc),.117/2,'facecolor',[0,204,102]/255,'edgecolor','none','FaceAlpha',0.1)
