...
% % surf(x*rad_myp+mean(rmyp(3,:)),y*rad_myp+rho_myp,z*rad_myp,'edgecolor','none','FaceColor','green','FaceAlpha','.3')
% % surf(x*rad_myp/2+mean(rmyp(3,:)),y*rad_myp/2+rho_myp,z*rad_myp/2,'edgecolor','none','FaceColor','green','FaceAlpha','.3')
% % Myo2p
% rad_myo = rcapmyo_short;
% [~,rho_myo] = cart2pol(rmyo(1,:),rmyo(2,:));
% rho_myo = mean(rho_myo);
% % surf(x*rad_myo+mean(rmyo(3,:)),y*rad_myo+rho_myo,z*rad_myo,'edgecolor','none','FaceColor','red','FaceAlpha','.3')
