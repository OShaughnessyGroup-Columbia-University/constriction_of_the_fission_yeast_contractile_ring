...
% %         end
        ...
        nsat_p = nsat;
        [force,force_vec, gbeadfv, gppf, bmmatpt, bpmatpt] = get_force_v12(rbead,rmyo,rmyp,rdiff,ifor,ipt,bancm,bmmat,bpmat,nhead,nheadmyp,fhead,fheadmyp,fone,nsat,nsatmyp,rcapmyo_u, rcapmyo_long, rcapmyo_short,rcapmyp,kcap,kcap_p,r_flat_myo,r_flat_myp,dbead,vmyo0,kod2,r_ring,kwall,kexc,kexc_po,rexc,rexc_n,rexc_po,kex_act,rex_act,xmat,rx0,kx,d_cdc15,d_myo,geometry);
