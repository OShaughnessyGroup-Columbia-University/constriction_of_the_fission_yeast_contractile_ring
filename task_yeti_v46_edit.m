...
% change from v26: use run_pos_z_cyl and parameters_v19, no constriction, name dpnew
% change from v27: use run_pos_z_cyl_v1, constriction, name dpfc
% v28 to v32 skipped
% change from v33: use parameters_v27, name dpfc1d
% v34 to v37 skipped
% change from v38: use parameters_v32, name dpnof
% v39 to v44 skipped
% change from v45: use parameters_v33 (WT), name wtnof2
...
%% run simulation
totaltime = 1; % ring radius divided by septation rate is 26 minutes  

for t = loadj:loadj + totaltime-1
    load(strcat(prefix,num2str(itask),'_',num2str(t),suffix))
    dt = .02;
    nstep = 1;      % one save per second
    equil_time_min = 10;
