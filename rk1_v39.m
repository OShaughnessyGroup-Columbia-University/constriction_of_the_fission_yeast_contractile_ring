...
% change from v32: use get_force_v12
% change from v36: use get_force_v13
% v37 skipped
% change from v38: use bm_nbr_v2 and bp_nbr_v3
    istore = 1:nstep;
...
if ~exist('bpmat','var')
    bpmat = bp_nbr_v3 (rbead, rmyp, ifor, ipt, rcapmyp, nheadmyp);
end
...
% %             poly_time = false;
% %         end
        [rbead,rmyo,rmyp,xmat,fmmat,ipt,ifor,bancf,bancm,dbead_first,bpmat_trial] = update_v16(rbead,rmyo,rmyp,bpmat,xmat,rhoain,rxbind,rex_act,rexc_n,fmmat,bancf,bancm,ifor,ipt,kofffor,...
        ...
        nsat_p = nsat;
        [force,force_vec, gbeadfv, gppf, bmmatpt, bpmatpt] = get_force_v13(rbead,rmyo,rmyp,rdiff,ifor,ipt,bancm,bmmat,bpmat,nhead,nheadmyp,fhead,fheadmyp,fone,nsat,nsatmyp,rcapmyo_u, rcapmyo_long, rcapmyo_short,rcapmyp,kcap,kcap_p,r_flat_myo,r_flat_myp,dbead,vmyo0,kod2,r_ring,kwall,kexc,kexc_po,rexc,rexc_n,rexc_po,kex_act,rex_act,xmat,rx0,kx,d_cdc15,d_myo,geometry);
