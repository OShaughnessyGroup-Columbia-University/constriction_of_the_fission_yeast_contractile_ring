...
%% 2d scan
x1 = linspace(6,25,8); % previous best value 11.4 = x1(3)
x2 = linspace(2,8.8,8); % previous best value 5.9 = x2(5)
[X1,X2] = meshgrid(x1,x2);
myp2p_unbinding_force = X1(itask);
max_repulsion_force = X2(itask);
%% Constants
% Misc.
